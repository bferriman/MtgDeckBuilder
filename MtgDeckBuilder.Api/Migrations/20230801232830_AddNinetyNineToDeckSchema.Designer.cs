...
namespace MtgDeckBuilder.Api.Migrations
{
    ...
    [Migration("20230801232830_AddNinetyNineToDeckSchema")]
    partial class AddNinetyNineToDeckSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MtgDeckBuilder.Api.Data.DeckItem", b =>
                {
                    ...
                    b.OwnsMany("MtgDeckBuilder.Api.Data.Card", "NinetyNine", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.HasIndex("DeckItemId");

                            b1.ToTable("DeckItems_NinetyNine");
